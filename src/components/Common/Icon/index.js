...
const FacebookIcon = () => {
  return (
    <svg className='facebook-icon' fill='#3b5998' xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
...
const PlusIcon = ({ className = '', width = '20', height = '20',color }) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='24'
...
const MinusIcon = ({ className = '', width = '20', height = '20' }) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='24'
...
const ConnectIcon = ({ className = '', width = '20', height = '20' }) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='24'
