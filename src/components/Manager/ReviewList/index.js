          ...
          <div className='mb-3 p-4'>
            ...
            <div className='d-flex flex-column flex-lg-row mx-0 mb-3 align-items-start justify-content-between'>
              <div className='w-100 mb-3 mb-lg-0 review-product-box'>
                {review.product ? (
                  <Link to={`/product/${review.product?.slug}`} className='default-link'>
                    {review?.product.name}
                  </Link>
                ) : (
                  <Link to={`/saleTemp/${review.saleTemp?.slug}`} className='default-link'>
                    {review?.saleTemp?.name}
                  </Link>
                )}
            ...
            <label className='text-black'>{`Review Added on ${formatDate(review.created)}`}</label>
            <hr />
